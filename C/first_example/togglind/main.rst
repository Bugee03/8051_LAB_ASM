      ...
      000049 02 00 CC         [24]  359 	ljmp	_main
                                    ...
                                    367 ;------------------------------------------------------------
                                    368 ;t             Allocated to registers r6 r7 
                                    369 ;i             Allocated to registers r4 r5 
                                    370 ;j             Allocated to registers r2 r3 
                                    371 ;------------------------------------------------------------
                                    372 ;	main.c:5: void delay(unsigned int t)
                                    373 ;	-----------------------------------------
                                    374 ;	 function delay
                                    375 ;	-----------------------------------------
      0000A8                        376 _delay:
                           ...
                           000001   383 	ar1 = 0x01
                           000000   384 	ar0 = 0x00
      0000A8 AE 82            [24]  385 	mov	r6, dpl
      0000AA AF 83            [24]  386 	mov	r7, dph
                                    387 ;	main.c:8: for (i = 0; i < t; i++)
      0000AC 7C 00            [12]  388 	mov	r4,#0x00
      0000AE 7D 00            [12]  389 	mov	r5,#0x00
      0000B0                        390 00107$:
      0000B0 C3               [12]  391 	clr	c
      0000B1 EC               [12]  392 	mov	a,r4
      0000B2 9E               [12]  393 	subb	a,r6
      0000B3 ED               [12]  394 	mov	a,r5
      0000B4 9F               [12]  395 	subb	a,r7
      0000B5 50 14            [24]  396 	jnc	00109$
                                    397 ;	main.c:9: for (j = 0; j < 120; j++);
      0000B7 7A 78            [12]  398 	mov	r2,#0x78
      0000B9 7B 00            [12]  399 	mov	r3,#0x00
      0000BB                        400 00105$:
      0000BB 1A               [12]  401 	dec	r2
      0000BC BA FF 01         [24]  402 	cjne	r2,#0xff,00138$
      0000BF 1B               [12]  403 	dec	r3
      0000C0                        404 00138$:
      0000C0 EA               [12]  405 	mov	a,r2
      0000C1 4B               [12]  406 	orl	a,r3
      0000C2 70 F7            [24]  407 	jnz	00105$
                                    408 ;	main.c:8: for (i = 0; i < t; i++)
      0000C4 0C               [12]  409 	inc	r4
      0000C5 BC 00 E8         [24]  410 	cjne	r4,#0x00,00107$
      0000C8 0D               [12]  411 	inc	r5
      0000C9 80 E5            [24]  412 	sjmp	00107$
      0000CB                        413 00109$:
                                    414 ;	main.c:10: }
      0000CB 22               [24]  415 	ret
                                    416 ;------------------------------------------------------------
                                    417 ;Allocation info for local variables in function 'main'
                                    418 ;------------------------------------------------------------
                                    419 ;	main.c:14: void main(void) {
                                    420 ;	-----------------------------------------
                                    421 ;	 function main
                                    422 ;	-----------------------------------------
      0000CC                        423 _main:
                                    424 ;	main.c:16: while (1) {
      0000CC                        425 00102$:
                                    426 ;	main.c:17: P1_0 = 0;
                                    427 ;	assignBit
      0000CC C2 90            [12]  428 	clr	_P1_0
                                    429 ;	main.c:18: delay(3000);
      0000CE 90 0B B8         [24]  430 	mov	dptr,#0x0bb8
      0000D1 12 00 A8         [24]  431 	lcall	_delay
                                    432 ;	main.c:19: P1_0 = 1;
                                    433 ;	assignBit
      0000D4 D2 90            [12]  434 	setb	_P1_0
                                    435 ;	main.c:20: delay(3000);
      0000D6 90 0B B8         [24]  436 	mov	dptr,#0x0bb8
      0000D9 12 00 A8         [24]  437 	lcall	_delay
                                    438 ;	main.c:22: P1_1 = 1;
                                    439 ;	assignBit
      0000DC D2 91            [12]  440 	setb	_P1_1
                                    441 ;	main.c:23: delay(3000);
      0000DE 90 0B B8         [24]  442 	mov	dptr,#0x0bb8
      0000E1 12 00 A8         [24]  443 	lcall	_delay
                                    444 ;	main.c:24: P1_1 = 0;
                                    445 ;	assignBit
      0000E4 C2 91            [12]  446 	clr	_P1_1
                                    447 ;	main.c:25: delay(3000);
      0000E6 90 0B B8         [24]  448 	mov	dptr,#0x0bb8
      0000E9 12 00 A8         [24]  449 	lcall	_delay
                                    450 ;	main.c:27: P1_2 = 1;
                                    451 ;	assignBit
      0000EC D2 92            [12]  452 	setb	_P1_2
                                    453 ;	main.c:28: P1_3 = 1;
                                    454 ;	assignBit
      0000EE D2 93            [12]  455 	setb	_P1_3
                                    456 ;	main.c:29: P1_4 = 1;
                                    457 ;	assignBit
      0000F0 D2 94            [12]  458 	setb	_P1_4
                                    459 ;	main.c:30: P1_5 = 1;
                                    460 ;	assignBit
      0000F2 D2 95            [12]  461 	setb	_P1_5
                                    462 ;	main.c:31: delay(2000); 
      0000F4 90 07 D0         [24]  463 	mov	dptr,#0x07d0
      0000F7 12 00 A8         [24]  464 	lcall	_delay
                                    465 ;	main.c:32: P1_6 = 1;
                                    466 ;	assignBit
      0000FA D2 96            [12]  467 	setb	_P1_6
                                    468 ;	main.c:34: }
      0000FC 80 CE            [24]  469 	sjmp	00102$
                                    470 	.area CSEG    (CODE)
                                    471 	.area CONST   (CODE)
                                    472 	.area XINIT   (CODE)
