      ...
      000008                        227 _main_numbs_10000_2:
      000008                        228 	.ds 9
                                    229 ;--------------------------------------------------------
                                    230 ; Stack segment in internal ram
                                    231 ;--------------------------------------------------------
                                    232 	.area SSEG
      000011                        233 __start__stack:
      000011                        234 	.ds	1
                                    235 
                                    236 ;--------------------------------------------------------
      ...
      000049 02 00 A8         [24]  360 	ljmp	_main
                                    ...
                                    368 ;------------------------------------------------------------
                                    369 ;numbs         Allocated with name '_main_numbs_10000_2'
                                    370 ;counter       Allocated to registers r7 
                                    371 ;------------------------------------------------------------
                                    372 ;	main.c:4: void main(void){
                                    373 ;	-----------------------------------------
                                    374 ;	 function main
                                    375 ;	-----------------------------------------
      0000A8                        376 _main:
                           ...
                           000001   383 	ar1 = 0x01
                           000000   384 	ar0 = 0x00
                                    385 ;	main.c:6: unsigned char numbs[] = {-4,-3,-2,-1,0,1,2,3,4};
      0000A8 75 08 FC         [24]  386 	mov	_main_numbs_10000_2,#0xfc
      0000AB 75 09 FD         [24]  387 	mov	(_main_numbs_10000_2 + 0x0001),#0xfd
      0000AE 75 0A FE         [24]  388 	mov	(_main_numbs_10000_2 + 0x0002),#0xfe
      0000B1 75 0B FF         [24]  389 	mov	(_main_numbs_10000_2 + 0x0003),#0xff
      0000B4 75 0C 00         [24]  390 	mov	(_main_numbs_10000_2 + 0x0004),#0x00
      0000B7 75 0D 01         [24]  391 	mov	(_main_numbs_10000_2 + 0x0005),#0x01
      0000BA 75 0E 02         [24]  392 	mov	(_main_numbs_10000_2 + 0x0006),#0x02
      0000BD 75 0F 03         [24]  393 	mov	(_main_numbs_10000_2 + 0x0007),#0x03
      0000C0 75 10 04         [24]  394 	mov	(_main_numbs_10000_2 + 0x0008),#0x04
                                    395 ;	main.c:9: for(counter = 0;counter <=8;counter++){
      0000C3 7F 00            [12]  396 	mov	r7,#0x00
      0000C5                        397 00102$:
                                    398 ;	main.c:10: P1 = numbs[counter];
      0000C5 EF               [12]  399 	mov	a,r7
      0000C6 24 08            [12]  400 	add	a, #_main_numbs_10000_2
      0000C8 F9               [12]  401 	mov	r1,a
      0000C9 87 90            [24]  402 	mov	_P1,@r1
                                    403 ;	main.c:9: for(counter = 0;counter <=8;counter++){
      0000CB 0F               [12]  404 	inc	r7
      0000CC EF               [12]  405 	mov	a,r7
      0000CD 24 F7            [12]  406 	add	a,#0xff - 0x08
      0000CF 50 F4            [24]  407 	jnc	00102$
                                    408 ;	main.c:12: }
      0000D1 22               [24]  409 	ret
                                    410 	.area CSEG    (CODE)
                                    411 	.area CONST   (CODE)
                                    412 	.area XINIT   (CODE)
